...
- <img src="fish.svg" width="32" height="32" align="middle"/> **[Virtual Aragonite Sensor](https://github.com/trentonallan/virtual-aragonite-sensor)** - ML pipeline for coral reef conservation
  ...
  - Predicts aragonite saturation state (an ocean acidification indicator) to assess threats to coral reefs from satellite data (R² = 0.80), replacing $10k/day research cruises with zero-cost screening
