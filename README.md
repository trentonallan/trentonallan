...
- **[Dartfrog](https://github.com/trentonallan/dartfrog)  <img src="frog.svg" width="32" height="32"/>**  - Multi-threaded HTTP/1.1 server built from scratch in Java - Multi-threaded HTTP/1.1 server built from scratch in Java
