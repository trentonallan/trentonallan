...
- **<img src="frog.svg" width="32" height="32" style="vertical-align: middle; margin: 0 4px;" />[Dartfrog](https://github.com/trentonallan/dartfrog)** - Multi-threaded HTTP/1.1 server built from scratch in Java - Multi-threaded HTTP/1.1 server built from scratch in Java
